...
// Admin / Manager / Developer Report Center — unchanged behavior. Extracted
// verbatim out of page.tsx so /dashboard/reports/view can dispatch by role
// server-side (see page.tsx): a client user gets the dedicated
// <ClientReportsView> instead, and never renders this component at all.
